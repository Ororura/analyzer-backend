...
public enum ResumeErrorCode {
    ...
    PDF_TOO_LARGE(HttpStatus.CONTENT_TOO_LARGE),
    RESUME_TEXT_TOO_LARGE(HttpStatus.CONTENT_TOO_LARGE),
    ...
    SELECTION_TOO_LARGE(HttpStatus.CONTENT_TOO_LARGE),
    VACANCY_NOT_FOUND(HttpStatus.NOT_FOUND),
    VACANCY_RATE_LIMITED(HttpStatus.TOO_MANY_REQUESTS),
    VACANCY_PROVIDER_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT),
    VACANCY_PROVIDER_FAILED(HttpStatus.BAD_GATEWAY),
    ...
    AI_PROCESS_START_FAILED(HttpStatus.SERVICE_UNAVAILABLE),
    AI_PROVIDER_FAILED(HttpStatus.BAD_GATEWAY),
