...
public class VacancySyncService {
    ...
    private final VacancySyncStore persistence;
    ...
    private final MarketProfileRefresher marketProfiles;
    private final ResumeAnalysisProfileRegistry profiles;

    public VacancySyncService(VacancyProvider provider, VacancySyncStore persistence,
            VacancySyncProperties properties, VacancyQueryCache cache, VacancyMarketVersion marketVersion,
            MarketProfileRefresher marketProfiles, ResumeAnalysisProfileRegistry profiles) {
    ...
    public VacancySyncStats synchronize() {
        ...
        for (String query : searchQueries()) {
            for (int page = 0; page < properties.pagesPerCycle(); page++) {
                ...
                List<List<com.ororura.analyzer.vacancy.domain.Vacancy>> batches = batches(
